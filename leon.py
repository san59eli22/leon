...
# --- 🚀 REFORMA DE ALTO IMPACTO: EFECTO DE IMPULSO DINÁMICO (HOVER PROFUNDO) ---
st.markdown("""
    <style>
    /* Ocultamos cabeceras de Streamlit */
    ...
    .tarjeta-leon {
        ...
        height: 270px;
        transition: all 0.25s cubic-bezier(0.25, 0.8, 0.25, 1) !important; /* Animación más rápida y elástica */
    }
    
    /* ✨ EFECTO AGRESIVO EN CAJA (CUANDO EL MOUSE PASA POR ENCIMA O SE TOCA) */
    .tarjeta-leon:hover {
        transform: translateY(-18px) !important; /* Eleva la tarjeta con fuerza hacia arriba */
        box-shadow: 0 20px 30px -5px rgba(0,0,0,0.2) !important; /* Sombra 3D profunda de flotación */
        background-color: #FFFFFF !important; /* Brillo blanco total */
        border-left-width: 10px !important; /* El borde de color se duplica en grosor */
    }
    </style>
...
if st.session_state["seccion_activa"] == "Portal Central":
    ...
    with col1:
        st.markdown("""
            <div class='tarjeta-leon' style='border-left: 5px solid #2563EB;'>
    ...
    with col2:
        st.markdown("""
            <div class='tarjeta-leon' style='border-left: 5px solid #D97706;'>
    ...
    with col3:
        st.markdown("""
            <div class='tarjeta-leon' style='border-left: 5px solid #DB2777;'>
