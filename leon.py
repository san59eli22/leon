...
# --- 🚀 ESTILOS VISUALES AVANZADOS CON EFECTO DE MOVIMIENTO (HOVER) ---
st.markdown("""
    <style>
    ...
    /* 🎭 ANIMACIÓN EN VIVO PARA LAS TRES TARJETAS */
    .tarjeta-leon {
    ...
    /* ✨ QUÉ PASA CUANDO EL MOUSE PASA POR ENCIMA (MOVIMIENTO) */
    .tarjeta-leon:hover {
        transform: translateY(-8px) !important; /* Eleva la tarjeta hacia arriba */
        box-shadow: 0 12px 20px -3px rgba(0,0,0,0.15) !important; /* Agrandará la sombra */
        background-color: #FFFFFF !important; /* Brilla más el fondo */
    }
    </style>
