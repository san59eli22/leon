...
# =========================================================================
    ...
    with col_f2:
        ...
        # Botón de acción simulado a WhatsApp
        numero_whatsapp = "5493873000000" # Acá ponés el número real después
        link_wa = f"https://wa.me{numero_whatsapp}?text=Hola%20Farmacia%20León,%20quiero%20enviar%20una%20receta"
...
# =========================================================================
    ...
    with col_p2:
        ...
        link_wa_pan = f"https://wa.me{numero_whatsapp}?text=Hola%20Panadería%20León,%20quiero%20hacer%20un%20pedido"
...
# =========================================================================
    ...
    with col_c2:
        ...
        link_wa_te = f"https://wa.me{numero_whatsapp}?text=Hola%20Cerezo,%20quiero%20reservar%20una%20mesa"
